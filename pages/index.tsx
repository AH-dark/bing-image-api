...
function ActiveLink({ path }: { path: string }) {
    ...
    const GoTo = (e: React.MouseEvent<HTMLSpanElement>) => {
        e.preventDefault();
        router.push(path);
    };
    ...
    return (
        <>
            ...
            <Container maxWidth={"xl"}>
                <Box mt={10} mb={4} className={styles.root}>
                    ...
                    <Typography variant={"body1"} component={"p"}>
                        {"API地址："}
                        <code>
                            {"https://bing-image-api.vercel.app/api/new"}
                        </code>
                        <br />
                        会直接返回302请求到图片，实测可正常使用。 详见
                        <Link
                            href={"https://www.alphapic.org.cn"}
                            target={"_blank"}
                            rel={"noopener"}
                        >
                            www.alphapic.org.cn
                    ...
                    <Typography variant={"body1"} component={"p"}>
                        {"API地址："}
                        <code>
                            {"https://bing-image-api.vercel.app/api/image"}
                        </code>
                        <br />
                        {
                    ...
                    <Typography variant={"body1"} component={"p"} mb={1}>
                        {"API地址："}
                        <code>
                            {"https://bing-image-api.vercel.app/api/custom"}
                        </code>
                        <br />
                        {"参数："}
                        <TableContainer
                        ...
                        <ul style={{ margin: "2px 0" }}>
                            ...
                            <li>
                                <ActiveLink
                                    path={"/api/custom?method=json&key=image"}
                                />
                            </li>
                            <li>
                            ...
                            <li>
                                <ActiveLink
                                    path={"/api/custom?method=element&key=img"}
                                />
                            </li>
                        </ul>
                    </Typography>
